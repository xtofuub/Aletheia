...
- A local device benchmark measures workspace read/write speed, CPU matching, memory copying, archive decompression, and available RAM, then recommends supported worker and writer-memory settings.
